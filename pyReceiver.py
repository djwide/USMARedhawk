...
# AUTO-GENERATED
#
# Source: pyReceiver.spd.xml
from ossie.resource import start_component
import logging

from pyReceiver_base import *

class pyReceiver_i(pyReceiver_base):
    ...
    def constructor(self):
        ...
        self.port_message_in.registerMessage("foo", pyReceiver_base.Foo, self.messageReceived)
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", pyReceiver_i.MyMsg, self.msg_callback)
